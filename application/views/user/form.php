...
<form method="POST" action="<?PHP echo(site_url($action)); ?>" id="user_edit_form" class="edit_form">
	<ul>
		<li>
			<input type="text" name="user_name" id="user_name" title="Name" value="<?PHP echo($user->name); ?>" />
			<label class="hint" for="user_name">Required.</label>
		</li>
		<li>
		...
		<li>
			<input type="password" name="user_password" id="user_password" title="Password" value="" />
