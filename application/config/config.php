...
|
| Changed: Swapped debug for info so I can log things important that are not
| stricty errors. - Matthew
|
...
$config['log_levels']['INFO'] 	= 2;
$config['log_levels']['DEBUG'] 	= 3;
$config['log_levels']['ALL'] 	= 4;
...
|
*/
$config['encryption_key'] = 'WXxqtONTbWur8yU9yYhmODgLCfVawCR6';
...
$config['sess_expiration']		= 1 * 18 * 60 * 60; //18 Hours
